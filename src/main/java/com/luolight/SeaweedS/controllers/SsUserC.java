...
@Controller
@RequestMapping(value = "SsUser",produces = "application/json;charset=UTF-8", method = RequestMethod.POST)
public class SsUserC {

	@Autowired
	private SsUserSI serviceImpl;

	@RequestMapping(value = "/insert")
	@ResponseBody
	public HashMap<String, Object> insert(SsUser model){
	...
	@ResponseBody
	public HashMap<String, Object> updateByPrimaryKeySelective(SsUser model){
	...
	public HashMap<String, Object> selectByPrimaryKey(Integer primaryKey){
		SsUser con = serviceImpl.selectByPrimaryKey(primaryKey);
		return Constans.returnCon(con, Constans.SUCCESS[0], Constans.SUCCESS[1]);
	}
	...
	public HashMap<String, Object> selectAll(){
		ArrayList<SsUser> con = serviceImpl.selectAll();
		return Constans.returnCon(con, Constans.SUCCESS[0], Constans.SUCCESS[1]);
	}
